...
- A: [Installation](https://github.com/Mr-Proxy-source/Nitro-Sniper/wiki/Installation)

<br />

- **Q: Where can I find the default configuration?**
- A: [Default Configuration](https://github.com/Mr-Proxy-source/Nitro-Sniper/wiki/Default-Configuration)

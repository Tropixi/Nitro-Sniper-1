...
module.exports = {
   ...
   invalidConfig: 'Invalid settings, please visit the FAQ for more information: https://github.com/Mr-Proxy-Source/Nitro-Sniper#faq. Exiting process...',
   noMode: 'No sniper mode provided in settings, exiting process...',
   invalidMode: 'Invalid mode provided, visit https://github.com/Mr-Proxy-Source/Nitro-Sniper#default-configuration for a list of modes. Exiting process...',
